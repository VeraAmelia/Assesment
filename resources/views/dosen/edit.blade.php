                        ...
                        <form action="{{ route('dosen.update', $dosens->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                    name="nip" value="{{ old('nip', $dosens->nip) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('dosen_name') is-invalid @enderror"
                                    name="dosen_name"
                                    value="{{ old('dosen_name', $dosens->dosen_name) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin"
                                    ...
                                    <option value="{{ $dosens->jenis_kelamin }}">{{ $dosens->jenis_kelamin }}
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                    name="tanggal_lahir" value="{{ old('tanggal_lahir', $dosens->tanggal_lahir) }}"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('no_tlp') is-invalid @enderror"
                                    name="no_tlp" value="{{ old('no_tlp', $dosens->no_tlp) }}" required>
                                ...
                                <select name="matkul_id" class="form-control @error('matkul_id') is-invalid @enderror"
                                    ...
                                    @foreach ($matkuls as $matkul)
                                        <option value="{{ $matkul->id }}"
                                            {{ $matkul->id == $dosens->matkul_id ? 'selected="selected"' : '' }}>
                                ...
                                <select name="prodi_id" class="form-control @error('prodi_id') is-invalid @enderror"
                                    ...
                                    @foreach ($prodis as $prodi)
                                        <option value="{{ $prodi->id }}"
                                            {{ $prodi->id == $dosens->prodi_id ? 'selected="selected"' : '' }}>
                            ...
                            <a href="{{ route('prodi.index') }}" class="btn btn-md btn-secondary">back</a>
                        </form>
                    </div>
                </div>
            </div>
